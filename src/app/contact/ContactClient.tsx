      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-full mx-auto px-4 md:px-24 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-3xl font-bold mb-6 text-semantic-primary">
                Send us a Message
              </h2>
            ...
            <div>
              ...
              <Card className="shadow-md mb-6">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold mb-2 text-cardHeader">
                        Support Hours
                      </h3>
              ...
              <div className="flex flex-col space-y-4 mb-8">
                <div className="flex items-center space-x-4">
                  <Phone className="h-5 w-5 text-semantic-primary" />
                  <p className="font-medium">
                    24/7 Crisis Support: 1-800-273-8255
                  </p>
                </div>
                <div className="flex items-center space-x-4">
                  <MessageCircle className="h-5 w-5 text-semantic-primary" />
                  <p className="font-medium">
                    Live Chat: Available during support hours
                  </p>
                </div>
                <div className="flex items-center space-x-4">
                  <Mail className="h-5 w-5 text-semantic-primary" />
                  <p className="font-medium">Email: support@mindmentor.com</p>
                </div>
              </div>

              {/* Office Locations */}
              <h3 className="text-2xl font-bold mb-4 text-semantic-primary">
                Our Offices
              </h3>
                ...
                {contactData.offices.map((office, index) => (
                  <Card key={index} className="shadow-sm">
                    <CardContent className="p-4">
                      <h4 className="text-lg font-semibold mb-2 text-semantic-primary">
                        {office.city}
                      </h4>
                      <p className="mb-2">{office.address}</p>
                      <p className="text-semantic-body">{office.phone}</p>
                      <p className="text-semantic-body">{office.email}</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
        ...
        {/* FAQ Section */}
        <div className="bg-semantic-primary/5 py-16">
            ...
            <div className="flex flex-col space-y-8 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <p className="text-semantic-body">
                    Yes, all communications are encrypted and HIPAA compliant.
                  </p>
                </div>
              </div>
            </div>
