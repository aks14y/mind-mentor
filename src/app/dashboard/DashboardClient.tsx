		...
		<div className="min-h-screen bg-white">
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
				<div className="flex flex-col space-y-8">
					{/* Welcome Section */}
					<Card className="rounded-2xl shadow-xl border border-brand-100">
						<CardContent className="p-6 md:p-8">
							<div className="flex justify-between items-center flex-wrap gap-6">
								<div className="flex flex-col space-y-2">
									<Badge className="bg-brand-50 text-brand-700 rounded-full px-3 py-1">
										Dashboard
									</Badge>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<Card className="rounded-2xl shadow-lg border border-brand-100">
							<CardContent className="p-6">
								<div className="space-y-2">
									<p className="text-sm font-medium text-brand-700">Sessions Completed</p>
									<p className="text-3xl font-bold text-brand-800">12</p>
									<p className="text-sm text-brand-600">+2 this week</p>
								</div>
						...
						<Card className="rounded-2xl shadow-lg border border-brand-100">
							<CardContent className="p-6">
								<div className="space-y-2">
									<p className="text-sm font-medium text-brand-700">Current Streak</p>
									<p className="text-3xl font-bold text-brand-800">7 days</p>
									<p className="text-sm text-brand-600">Keep it up!</p>
								</div>
						...
						<Card className="rounded-2xl shadow-lg border border-brand-100">
							<CardContent className="p-6">
								<div className="space-y-2">
									<p className="text-sm font-medium text-brand-700">Next Session</p>
									<p className="text-3xl font-bold text-brand-800">Tomorrow</p>
									<p className="text-sm text-brand-600">2:00 PM</p>
								</div>
					...
					<Card className="rounded-2xl shadow-lg border border-gray-100">
						<CardContent className="p-6 md:p-8">
							<div className="flex flex-col space-y-6">
								<h2 className="text-xl font-semibold text-brand-700">Recent Activity</h2>
